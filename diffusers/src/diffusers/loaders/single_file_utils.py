...
# NOTE: Schedulers are imported lazily inside `_legacy_load_scheduler` to avoid
# hard import-time dependencies on scheduler modules that may be trimmed.
from ..utils import (
    ...
    **kwargs,
    ...
    if scheduler_type is None:
        ...
        try:
            ...
            raise ImportError(
                "LMSDiscreteScheduler is not available in this build. "
                "Remove the LMS scheduler option or install a diffusers build "
                "that includes scheduling_lms_discrete."
            ) from exc
